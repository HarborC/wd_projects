...
from src.utils.build_pycolmap_recon import build_pycolmap_reconstruction, build_pycolmap_reconstruction_v2
...
def main():
    ...
    if args.save_colmap:
        ...
        reconstruction = build_pycolmap_reconstruction2(
            points=f_pts,
            pixel_coords=f_xyf,
            point_colors=f_cols,
            poses=extrinsics,
